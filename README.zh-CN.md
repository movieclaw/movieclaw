...
- 不是影视的内容也有地方放："其他"库收家庭录像、自录视频，不识别不改名，有 NFO 读 NFO、没有按文件名展示，封面从视频里抓帧；"图片"库收照片和截图，扫描目录里的所有图片，按 EXIF 拍摄时间排成按月分组的瀑布流相册墙，点开全屏看原图、滚轮缩放、方向键翻页，缩略图从原图缩放而来，网格永远不加载原图。
...
v0.27.0 之后发布的版本采用 [MovieClaw 许可证](LICENSE)：在 Apache License 2.0
的基础上附加了非商业条件。

- **非商业使用免费**：个人或家庭自托管、在亲友范围内共享、学习研究。
